# Contributing to Performance Monitor Analyser
...
5. Before sending PR to make sure that you rebased the latest `main` branch from the Performance Monitor Analyser repository.
6. When you're ready to create the [Pull Request on GitHub](https://github.com/skarllot/perfmon-explorer/compare).
...
By contributing to Performance Monitor Analyser:
